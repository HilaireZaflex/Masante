...
public class CompteController {
    ...
    public String creerCompte(@RequestBody Compte compte){
        return this.compteService.CreerCompte(compte);
    }
    ...
    public Compte connexion(
            ...
            @PathVariable Integer motDePasse){
    ...
    public Compte addMedecin(@RequestBody Medecin medecin){
        return compteService.addMedecin(medecin);
    }
